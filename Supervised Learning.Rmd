...
relative error to evaluate between models that are not on the same scale or factor.
Example: modeling small purchases vs. large purchases. RMSE may be larger in the latter, but the relative error could be smaller.
