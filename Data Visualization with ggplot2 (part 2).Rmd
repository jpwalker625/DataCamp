...
The `crabs` data set comes from the `MASS` package. The RW refers to measurement of rear width (mm) and the CW refers to the measurement of carpace width (mm), or the upper segement of the crab. 
```{r}
...
As you can see the plot above is unreadable. Let's fix this with by calling some arguments to the `facet_grid` function. 
